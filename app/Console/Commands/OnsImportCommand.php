...
class OnsImportCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'report:import-ons';
    ...
    public function handle()
    {
        try {
            ...
            $url = "https://dashboard-api.tgju.org/v1/tv2/history?symbol=ons&resolution=1D&from={$startDateTime}&to={$endDateTime}";
